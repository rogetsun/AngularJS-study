describe("", function() {
  ...
  beforeEach(function() {
    ...
    browser.get("examples/example-location-hashbang-mode/01.html");
  });
  
  var addressBar = element(by.css("#addressBar")),
       url = 'http://www.example.com/base/01.html#!/path?a=b#h';
  ...
  it("should change $location accordingly", function(){
    ...
    expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/01.html#!/first?a=b");
    ...
    expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/01.html#!/sec/ond?flag#hash");
